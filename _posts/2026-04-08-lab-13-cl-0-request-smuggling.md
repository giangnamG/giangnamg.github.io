...
6. Sử dụng menu thả xuống bên cạnh nút **Send**, thay đổi chế độ gửi thành **Send group in sequence (single connection)**
    ...
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image.png' | relative_url })
    
    Quan sát phản hồi của tab `normal`
    
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image%201.png' | relative_url })
    
7. Truy cập vào /admin
    
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image%202.png' | relative_url })
    
    Quan sát phản hồi của tab normal
    
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image%203.png' | relative_url })
    
8. Tiến hành xóa carlos
    
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image%204.png' | relative_url })
    
    Quan sát phản hồi của tab normal
    
    ![image.png]({ '/assets/img/portswigger-labs/lab-13-cl-0-request-smuggling/image%205.png' | relative_url })
